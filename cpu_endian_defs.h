#ifndef _CPU_ENDIAN_DEFS_H
#define _CPU_ENDIAN_DEFS_H
/**
 * @file cpu_endian.h
...
extern uint16_t swapInt16(uint16_t value);                                      //Byte order conversion functions
extern uint32_t swapInt32(uint32_t value);
extern uint64_t swapInt64(uint64_t value);

extern uint8_t reverseInt4(uint8_t value);                                      //Bit reversal functions
